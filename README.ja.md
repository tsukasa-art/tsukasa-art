...
## Melammu — Apple Silicon で Windows 美少女ゲームを動かす

**[Launcher](https://github.com/tsukasa-art/melammu-vn) · [Wine Fork (swingby-wine)](https://github.com/tsukasa-art/swingby-wine)**

Apple Silicon Mac 上で Windows 専用の美少女ゲームを動かすための互換スタック。Wine 10.0 をフォーク（[swingby-wine](https://github.com/tsukasa-art/swingby-wine)）し、ゲーム向けパッチ（D3D9 サーフェスフック・GDI BitBlt フックによるセーブサムネイル注入）を実装。Swift/SwiftUI 製ランチャーで、タイトルごとの Wine prefix 管理・kqueue ファイル監視・ScreenCaptureKit ウィンドウキャプチャを提供します。
...
動作確認済みタイトル一覧 → [Zenn連載](https://zenn.dev/tsukasa_art/articles/mac-eroge-compat-part1)
