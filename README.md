...
| **zigpix**               | MIT ライセンスの画像処理ライブラリ zigpix。Zig/C のネイティブ実装を Node.js / Bun / Deno（FFI）から利用し、デコード・リサイズ・AVIF/WebP エンコードなどを提供（ブラウザ向けは zigpix-wasm） | [npm](https://www.npmjs.com/package/zigpix) · [リポジトリ](https://github.com/Tuki-Sana/zig-pix)                         |
